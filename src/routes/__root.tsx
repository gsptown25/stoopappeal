  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#F6F1E8" },
      {
        name: "description",
        content:
          "Stoop Appeal is Portland's porch concierge. The Gathering and The Harvest — designed, delivered, styled, and collected.",
      },
    ],
    links: [
      { rel: "icon", type: "image/svg+xml", href: "/favicon.svg?v=door" },
